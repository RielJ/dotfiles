...
-- Layout: ... | wallpaper | media | volume | cpu | memory | wifi | battery | calendar (rightmost)
...
require("items.widgets.media") -- Media
require("items.widgets.wallpaper") -- Wallpaper manager
