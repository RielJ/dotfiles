...
keymap("n", "<leader>lt", "<cmd>lua require('rielj.lsp.handlers').apply_all_tailwind_actions_buffer()<CR>", opts)
...
keymap("n", "<leader>lk", "<cmd>lua vim.diagnostic.goto_prev({float=true})<CR>", opts)
